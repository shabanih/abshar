    ...
    var N = function (h) {
        ...
        function Aa(a, b) {
            var c = p.defaults.column,
                ...
                c = h.extend({}, p.models.oColumn, c, { nTh: b ? b : O.createElement("th"), sTitle: c.sTitle ? c.sTitle : b ? b.innerHTML : "", aDataSort: c.aDataSort ? c.aDataSort : [d], mData: c.mData ? c.mData : d, idx: d });
            a.aoColumns.push(c);
            c = a.aoPreSearchCols;
            ...
            if (-1 !== h.inArray(!1, b)) B(a, !1);
                ...
                if (0 !== i.length) {
                    ...
                    (c = f.sZeroRecords),
                        ...
                        (b[0] = h("<tr/>", { class: e ? d[0] : "" }).append(h("<td />", { valign: "top", colSpan: Z(a), class: a.oClasses.sRowEmpty }).html(c))[0]);
        ...
        function sb(a) {
            ...
            k("iDisplayStart", g);
            k("iDisplayLength", i);
            var l = { draw: a.iDraw, columns: [], order: [], start: g, length: i, search: { value: e.sSearch, regex: e.bRegex } };
            for (g = 0; g < c; g++)
                (n = b[g]),
                    (m = f[g]),
                    (i = "function" == typeof n.mData ? "function" : n.mData),
                    l.columns.push({ data: i, name: n.sName, searchable: n.bSearchable, orderable: n.bSortable, search: { value: m.sSearch, regex: m.bRegex } }),
                    k("mDataProp_" + g, i),
        ...
        function nb(a) {
            var b = a.oClasses,
                ...
                i = h("input", b)
                    ...
                    .bind("keyup.DT search.DT input.DT paste.DT cut.DT", "ssp" === z(a) ? Ma(f, 400) : f)
                    ...
                    h("<div/>", { class: f.sScrollHead })
                        ...
                        .append(
                            h("<div/>", { class: f.sScrollHeadInner })
                                ...
                                .append(i.removeAttr("id").css("margin-left", 0).append(b.children("thead")))
                        )
                        .append("top" === j ? g : null)
                )
                .append(
            ...
            m &&
                c.append(
                    h("<div/>", { class: f.sScrollFoot })
                        ...
                        .append(h("<div/>", { class: f.sScrollFootInner }).append(n.removeAttr("id").css("margin-left", 0).append(b.children("tfoot"))))
        ...
        function Sa(a, b, c, d) {
            ...
            c && a.oFeatures.bSortMulti
                ? ((c = h.inArray(b, C(e, "0"))), -1 !== c ? ((b = g(e[c])), (e[c][1] = f[b]), (e[c]._idx = b)) : (e.push([b, f[0], 0]), (e[e.length - 1]._idx = 0)))
                : e.length && e[0][0] == b
        ...
        function Ua(a, b) {
            ...
            b <= c
                ...
                : (a >= b - 1 - d ? (c = S(b - (c - 2), b)) : ((c = S(a - 1, a + 2)), c.push("ellipsis"), c.push(b - 1)), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0));
            c.DT_el = "span";
            return c;
        }
        function cb(a) {
        ...
        p = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) P(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    n = k.oClasses;
                    g.bJQueryUI
                        ? (h.extend(n, p.ext.oJUIClasses, g.oClasses), g.sDom === m.sDom && "lfrtip" === m.sDom && (k.sDom = '<"H"lfr>t<"F"ip>'), k.renderer)
                            ? h.isPlainObject(k.renderer) && !k.renderer.header && (k.renderer.header = "jqueryui")
                            : (k.renderer = "jqueryui")
        ...
        r("search()", function (a, b, c, d) {
            ...
            return a === l
                ...
                : this.iterator("table", function (e) {
                      e.oFeatures.bFilter && ca(e, h.extend({}, e.oPreviousSearch, { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), 1);
                  });
        });
        ...
        p.defaults = {
            ...
            oLanguage: {
                ...
                oPaginate: { sFirst: "First", sLast: "Last", sNext: "بعدی", sPrevious: "قبلی" },
                sEmptyTable: "No data available in table",
                sInfo: "نمایش _START_ تا _END_ از _TOTAL_ رکورد",
                sInfoEmpty: "نمایش 0 تا 0 از 0 رکورد",
                sInfoFiltered: "(فیلتر شده از بین _MAX_  رکورد)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                        ...
                        o = function (b, d) {
                            ...
                            for (p = d.length; k < p; k++) {
                                ...
                                if (h.isArray(q)) {
                                    ...
                                    if (i) {
                                        r = h("<a>", { class: g.sPageButton + " " + l, "aria-controls": a.sTableId, "data-dt-idx": m, tabindex: a.iTabIndex, id: c === 0 && typeof q === "string" ? a.sTableId + "_" + q : null })
                                            .html(i)
                                            .appendTo(b);
                                        Ta(r, { action: q }, s);
                                        m++;
                    ...
                    h(a.nTable).on("order.dt.DT", function (f, g, h, i) {
                        if (a === g) {
                            ...
                            b.find("span." + d.sSortIcon)
                                ...
                                .addClass(i[e] == "asc" ? d.sSortJUIAsc : i[e] == "desc" ? d.sSortJUIDesc : c.sSortingClassJUI);
                        }
                    });
                },
            },
